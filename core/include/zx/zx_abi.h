...
typedef struct zx_device_desc  { uint32_t size; uint32_t reserved; } zx_device_desc;
typedef struct zx_scene_desc   { uint32_t size; uint32_t reserved; } zx_scene_desc;
typedef struct zx_material_desc{ uint32_t size; uint32_t reserved; } zx_material_desc;
typedef struct zx_rig_desc     { uint32_t size; uint32_t reserved; } zx_rig_desc;

typedef struct zx_frame_begin  { uint32_t size; double time_seconds; } zx_frame_begin;
typedef struct zx_sim_params   { uint32_t size; float dt; uint32_t substeps; } zx_sim_params;
...
typedef struct zx_frame_end    { uint32_t size; uint64_t fence; } zx_frame_end;
