...
extern "C"
{
   ...
   */
  ZX_API zx_particle_soa ZX_CALL
  zx_create_particle_so_a(size_t count, void* (*alloc_fn)(size_t, void*),
   ...
   */
  ZX_API void ZX_CALL
  zx_destroy_particle_so_a(zx_particle_soa* soa, void (*free_fn)(void*, void*),
                           void* user);  // NOLINT(readability-identifier-naming)
